You are Claude Code working on **Snug (the Snug Protocol)**. Skills and subagents are available — use them. This file is intentionally lite; the wiki under `docs/` is the source of truth.
