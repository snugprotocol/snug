You are Gemini working on **Snug (the Snug Protocol)**. This is the config Gemini reads. This file is intentionally lite; the wiki under `docs/` is the source of truth.
