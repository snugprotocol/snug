...
4. **Commit**: show `git status`, commit everything (task-id-prefixed). Merged & finished → add one line to `docs/tasks/done/INDEX.md` and delete the task file (ADR-0027; git history keeps the full text).
