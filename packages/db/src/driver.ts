...
/** `PersistenceKind` as surfaced to embedders: every real kind as itself, `memory` as `'none'`. */
export type DbPersistence = 'opfs' | 'idb' | 'file' | 'window-storage' | 'artifact-html' | 'none';
