...
- `data_read` — a question the app's stored data can answer: totals, trends, lookups,
  comparisons, "what did I spend on food last month", "how many did I finish".
- `data_write` — adding, correcting or removing data: "add a £12 lunch for last Tuesday",
  "mark habit 3 done today", "delete the duplicate row".
