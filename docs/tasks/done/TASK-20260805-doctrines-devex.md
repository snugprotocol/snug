...
- Review findings and dispositions:
  ...
  - **#6 (queued):** `docs/tasks/` ships public at flip — task files need a machine-path/breadcrumb sweep (umbrella file carries `/Users/…` paths + a key-location note); queued for AL-14's runbook.
